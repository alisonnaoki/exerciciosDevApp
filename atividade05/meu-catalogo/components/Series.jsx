...
export default function Series(props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.texto}>Número de Temporadas: <Text style={styles.info}>{temporadas}</Text></Text>
    </View>
  );
}
...
const styles = StyleSheet.create({
  container: {
    ...
    shadowRadius: 8,
    elevation: 10,
    maxWidth: 350, // Ensures the content doesn't get too wide on larger screens
  },
  capa: {
    width: 250,
    height: 375,
